...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        pool_out_h, pool_out_w = 1 + (input_dim[1]-2)//2, 1 + (input_dim[2]-2)//2
    ...
    def loss(self, X, y=None):
        ...
        d3, grads['W3'], grads['b3'] = affine_backward(dout, cache3)
        d2, grads['W2'], grads['b2'] = affine_relu_backward(d3, cache2)
        _, grads['W1'], grads['b1'] = conv_relu_pool_backward(d2, cache1)
        
        grads['W1'] += 0.5 * self.reg * self.params['W1']
        grads['W2'] += 0.5 * self.reg * self.params['W2']
        grads['W3'] += 0.5 * self.reg * self.params['W3']
